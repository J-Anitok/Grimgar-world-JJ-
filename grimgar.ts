/* Upgraded grimgar.ts
   - currency conversions (bronze base)
   - numeric prices and inventory improvements
   - Player money sheet and bank with interest + persistence (localStorage)
   - Stat and substat threshold logic + configurable thresholds
   - Ripple system (sub -> parents; core -> sub)
   - NPC training schedule and batch train
   - Scavenger loot roll, valuation, and splitting
*/
